...
El conjunt de dades generat és d’interès principalment per a gestors en relació a la conservació de la biodiversitat a nivell nacional. El conjunt de dades permet no només comptabilitzar el nombre d’espècies d’arbres i arbusts presents a Espanya sinó també realitzar anàlisis de la seva distribució territorial i per tant permetent l’ajust de polítiques de conservació i gestió de la biodiversitat adaptades a cada regió.
...
2. 
-Quines són les de províncies amb  més riquesa d'espècies. CAL REDATA i ihspoteiR
...
3. Hi ha correlació entre la qualitat de l'arbrat i la riquesa nativa? i invasora? *H3*: FALTA
